class UI {
    ...
    submitBudgetForm() {
        const value = parseInt(this.budgetInput.value);
  ...
  <div class="expense-item d-flex justify-content-between align-items-baseline">
       ...
       <div class="expense-icons list-item">
        <a href="#" class="edit-icon mx-2" data-id="${new Date().getMilliseconds()}">
         <i class="fas fa-edit"></i>
        </a>
        <a href="#" class="delete-icon" data-id="${new Date().getMilliseconds()}">
